...
type Task struct {
	ID                 uint64 `gorm:"column:id,primaryKey,autoIncrement" json:"id" toml:"id" yaml:"id"`
	...
	Active             uint8  `gorm:"column:active" json:"active" toml:"active" yaml:"active"`
	CreatedAt          uint64 `gorm:"column:created_at,autoCreateTime:nano" json:"created_at" toml:"created_at" yaml:"created_at"`
	CreatedBy          string `gorm:"column:created_by" json:"created_by,omitempty" toml:"created_by" yaml:"created_by,omitempty"`
	UpdatedAt          uint64 `gorm:"column:updated_at,autoUpdateTime:nano" json:"updated_at" toml:"updated_at" yaml:"updated_at"`
